...
class IssueListProcessing extends StatefulWidget {
  IssueListProcessing({Key? key}) : super(key: key);

  @override
  State<IssueListProcessing> createState() => _IssueListProcessingState();
}

class _IssueListProcessingState extends State<IssueListProcessing> {
  Future<issueList> getPostApi_processing() async {
    ...
    if (response.statusCode == 201) {
      ...
      // print('abc_processing Testing :  ${abc_processing[1]['title']}');
      // print('\nPakistan : ${y}\n');
      // }
      // Fluttertoast.showToast(msg: msg)
      print('Processing Length: ${abc_processing.length}');
      // print('Sorted List \n $sorted_issue');
                  ...
                  builder: (context,AsyncSnapshot snapshot) {
                    if(snapshot.data!=null){
                      return ListView.builder(
                        itemCount: abc_processing.length,
                        itemBuilder: (context, index) {
                          status=checkValue(abc_processing[index]['issue_type']);
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            child: Column(
                                              children: [
                                                CircleAvatar(
                                                  backgroundImage: NetworkImage(abc_processing[index]['image']),
                                                  radius: 35,
                                          ...
                                          Flexible(
                                            child: Padding(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  Text(abc_processing[index]['title']),
                                                  Text(abc_processing[index]['status']),
                                                  Text(abc_processing[index]['description']),
                                                  Text(abc_processing[index]['languages']),
                                                  // Text(snapshot
